...
export class BeltCrossingSystem extends shapezAPI.exports.GameSystemWithFilter {
    constructor(root) {
    ...
    isAcceptorSlotFree(entity, slotIndex) {
        assert(entity.components.ItemAcceptor, "To accept items, the building needs to have an Item Acceptor");
